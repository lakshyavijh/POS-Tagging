class Hmmcompare:
    def compare(self, filename1, filename2):
        file1 = open(filename1, 'r',encoding="utf8")  # your tagged file
        file2 = open(filename2, 'r',encoding="utf8")      # tagged dev data

        """
        file1 = open('test/results/hmmoutput_en.txt', 'r',encoding="utf8")  # your tagged file
        file2 = open('test/en_test_tagged.txt', 'r',encoding="utf8")      # tagged dev data
        """
        correct_count = 0
        incorrect_count = 0
